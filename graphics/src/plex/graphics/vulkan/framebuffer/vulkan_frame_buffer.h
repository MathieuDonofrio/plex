#ifndef PLEX_GRAPHICS_VULKAN_FRAME_BUFFER_2_H
#define PLEX_GRAPHICS_VULKAN_FRAME_BUFFER_2_H

#include "plex/graphics/vulkan/attachments/vulkan_attachment.h"
...
#include "plex/graphics/vulkan/attachments/vulkan_attachment_group.h"

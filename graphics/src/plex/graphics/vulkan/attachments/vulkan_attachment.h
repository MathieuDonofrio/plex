#ifndef PLEX_GRAPHICS_VULKAN_ATTACHMENT_2_H
#define PLEX_GRAPHICS_VULKAN_ATTACHMENT_2_H

#include "plex/graphics/vulkan/attachments/vulkan_attachment_type.h"
...
struct VulkanAttachmentCreateInfo
{
  ...
  VulkanAttachmentCreateInfo(uint32_t attachment_index,
    LayoutTransitionSequence layout_transition_sequence,
    AttachmentOp attachment_op,
    AttachmentType attachment_type)
    : attachment_index(attachment_index), layout_transition_sequence(layout_transition_sequence),
      attachment_op(attachment_op), attachment_type(attachment_type)
  {}
};

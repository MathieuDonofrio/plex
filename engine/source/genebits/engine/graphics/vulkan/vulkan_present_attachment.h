...
class VulkanPresentAttachment : public VulkanColorAttachment
{
public:
  VulkanPresentAttachment(uint32_t attachment_index, VkFormat format)
    : VulkanColorAttachment(attachment_index,
      format,
